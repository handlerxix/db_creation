...
public class Company extends TableImpl<CompanyRecord> {
    ...
    /**
     * The column <code>public.company.individual_tax_number</code>.
     */
    public final TableField<CompanyRecord, String> INDIVIDUAL_TAX_NUMBER = createField(DSL.name("individual_tax_number"), SQLDataType.VARCHAR.nullable(false), this, "");
    /**
     * The column <code>public.company.company_check</code>.
     */
    public final TableField<CompanyRecord, String> COMPANY_CHECK = createField(DSL.name("company_check"), SQLDataType.VARCHAR.nullable(false), this, "");
